    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            ...
            if(chessBoardList.getChessBoard()[tableNumber].getChessBoardPlayerListWindow().getBoardHost().getUserId().equals(userId) == true){
                Player invitedPlayer = gameRoom.getGameRoomPlayerListWindow().getPlayer(invitedId);

                ChessBoard playerChessBoard = chessBoardList.isPlayerInChessBoard(invitedPlayer);

                if(playerChessBoard != null){
                    playerChessBoard.getChessBoardMessageWindow().appendMessageToThisPlayerMessage(invitedPlayer, invitation);

                }else if(playerChessBoard == null){
                    gameRoom.getGameRoomMessageWindow().addMessageToThisPlayerMessage(invitedPlayer, invitation);
                }
            /*
