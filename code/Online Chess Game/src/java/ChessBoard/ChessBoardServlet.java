...
public class ChessBoardServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            ...
            JSONArray player = gameRoom.getChessBoardList().getChessBoard()[tableNumber].getChessBoardPlayerListWindow().getJsonPlayers();
            JSONObject messages = gameRoom.getChessBoardList().getChessBoard()[tableNumber].getChessBoardMessageWindow().getJsonUserMessages(userId);
            if(messages != null){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ChessBoardServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
