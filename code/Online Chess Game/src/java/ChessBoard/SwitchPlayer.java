 ...
 * @author ALI
 */
@WebServlet(name = "SwitchPlayer", urlPatterns = {"/SwitchPlayer"})
public class SwitchPlayer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SwitchPlayer</title>");            
            out.println("</head>");
            out.println("<body>");
            */
            ...
            if(chessPlayBoard.getCurrentPlayerControl().equals("")){
                chessPlayBoard.switchPlayer();
                chessPlayBoard.startTimePerMove();
            }
                               
            /*
            out.println("<h1>Servlet SwitchPlayer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        }
